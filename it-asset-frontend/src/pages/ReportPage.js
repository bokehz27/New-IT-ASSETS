...
const ReportPage = () => {
  const availableFields = [
    ...
    { key: "wifi_registered", label: "WiFi Registered" },
    ...
    { key: "fin_asset_ref", label: "Fin Asset" },
    { key: "user_id", label: "User ID" },
    { key: "user_name", label: "User Name" },
    { key: "department", label: "Department" },
    { key: "status", label: "Status" },
    { key: "windows_version", label: "Windows Version" },
    { key: "windows_key", label: "Windows Key" },
  ...
  const handlePresetChange = (event) => {
    ...
    if (selectedPreset) {
      availableFields.forEach((field) => {
        newSelectedFields[field.key] = selectedPreset.fields.includes(
          field.key
        );
      });
    }
  ...
  const handleExport = async () => {
    ...
    const mainFieldsToExport = Object.keys(selectedFields).filter(
      (field) =>
        ...
        field !== "export_special_programs" &&
        field !== "export_bitlocker_keys"
    );
    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Or select fields manually below:
        </p>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Select the fields you want above, then give your preset a name and
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200 w-full sm:w-auto flex-shrink-0"
          >
