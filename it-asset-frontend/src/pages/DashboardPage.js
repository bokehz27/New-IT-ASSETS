...
// --- [ดีไซน์ใหม่] Quick Action Button Component ---
...
function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* --- [ดีไซน์ใหม่] Quick Actions --- */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <ActionButton to="/add" icon={'💻+'} title="เพิ่มสินทรัพย์ใหม่" subtitle="เพิ่มอุปกรณ์ IT ชิ้นเดียว" />
        <ActionButton to="/admin/create-ticket" icon={'🎫+'} title="สร้าง Ticket" subtitle="เปิดใบแจ้งซ่อมสำหรับแอดมิน" />
        <ActionButton to="/import" icon={'📤'} title="นำเข้าข้อมูล" subtitle="เพิ่มสินทรัพย์หลายชิ้นจากไฟล์" />
        <ActionButton to="/settings/user_name" icon={'👥+'} title="เพิ่มผู้ใช้" subtitle="จัดการข้อมูลผู้ใช้งาน" />
      </div>
      
      {/* --- [ดีไซน์ใหม่] Main Content Grid --- */}
