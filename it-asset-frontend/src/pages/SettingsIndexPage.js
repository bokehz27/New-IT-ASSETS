...
import {
  ...
  FiGitBranch, FiMap // 1. เพิ่มไอคอนใหม่
} from "react-icons/fi";
...
const groupedCategories = [
  {
    ...
    items: [
      { name: "Categories", type: 'master', icon: <FiServer />, endpoint: "categories", title: "Category", dataColumns: [{ key: 'name', name: 'Category Name' }] },
      { name: "Subcategories", type: 'relational', icon: <FiBox />, config: {} },
      { name: "Brands", type: 'master', icon: <FiTag />, endpoint: "brands", title: "Brand", dataColumns: [{ key: 'name', name: 'Brand Name' }] },
      { name: "Models", type: 'relational', icon: <FiGitMerge />, config: {} },
      { name: "Asset Statuses", type: 'master', icon: <FiClipboard />, endpoint: "asset_statuses", title: "Asset Status", dataColumns: [{ key: 'name', name: 'Status Name' }] },
    ]
  },
  {
    groupName: "Hardware & Software",
    items: [
      { name: "CPUs", type: 'master', icon: <FiCpu />, endpoint: "cpus", title: "CPU", dataColumns: [{ key: 'name', name: 'CPU Name' }] },
      { name: "RAMs", type: 'master', icon: <FiDatabase />, endpoint: "rams", title: "RAM", dataColumns: [{ key: 'size', name: 'RAM Size' }] },
      { name: "Storages", type: 'master', icon: <FiHardDrive />, endpoint: "storages", title: "Storage", dataColumns: [{ key: 'size', name: 'Storage Size' }] },
      { name: "Windows Versions", type: 'master', icon: <FiTv />, endpoint: "windows_versions", title: "Windows Version", dataColumns: [{ key: 'name', name: 'Version Name' }] },
      { name: "Office Versions", type: 'master', icon: <FiFileText />, endpoint: "office_versions", title: "Office Version", dataColumns: [{ key: 'name', name: 'Version Name' }] },
      { name: "Antivirus", type: 'master', icon: <FiShield />, endpoint: "antivirus_programs", title: "Antivirus Program", dataColumns: [{ key: 'name', name: 'Program Name' }] },
      { name: "Special Programs", type: 'master', icon: <FiStar />, endpoint: "special-programs", title: "Special Program", dataColumns: [{ key: 'name', name: 'Program Name' }] },
    ]
  },
  {
    groupName: "Personnel & Location",
    items: [
      { name: "Departments", type: 'master', icon: <FiBriefcase />, endpoint: "departments", title: "Department", dataColumns: [{ key: 'name', name: 'Department Name' }] },
      { name: "Locations", type: 'master', icon: <FiMapPin />, endpoint: "locations", title: "Location", dataColumns: [{ key: 'name', name: 'Location Name' }] },
      { name: "Positions", type: 'master', icon: <FiUsers />, endpoint: "positions", title: "Position", dataColumns: [{ key: 'name', name: 'Position Name' }] },
      { name: "Employees", type: 'relational', icon: <FiUsers />, config: {} },
      { name: "Emails", type: 'master', icon: <FiMail />, endpoint: "emails", title: "Email", dataColumns: [{ key: 'email', name: 'Email Address' }] },
    ]
  },
  {
    groupName: "Network & IP",
    items: [
      { name: "VLANs", type: 'master', icon: <FiGitBranch />, endpoint: "vlans", title: "VLAN", dataColumns: [ { key: 'name', name: 'VLAN Name' }, { key: 'vlan_number', name: 'VLAN Number' }, { key: 'site', name: 'Site / Location' }, ] },
      { name: "IP Pools", type: 'relational', icon: <FiMap />, config: {
          apiEndpoint: "ip-pools",
          title: "IP Address Pool",
          dataColumns: [{ key: 'ip_address', name: 'IP Address' }, { key: 'vlan_id', name: 'VLAN' }],
          relations: [{ apiEndpoint: 'vlans', foreignKey: 'vlan_id', displayField: 'name', label: 'VLAN' }]
      }},
    ]
  }
];
...
findItem('Employees').config = {
  ...
  title: "Employee",
  dataColumns: [{ key: 'name', name: 'Employee Name' }, { key: 'email_id', name: 'Email' }, { key: 'position_id', name: 'Position' }, { key: 'department_id', name: 'Department' }, { key: 'status', name: 'Status' }],
  relations: [
