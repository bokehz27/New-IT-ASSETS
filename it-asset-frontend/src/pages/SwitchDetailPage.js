...
const SwitchIcon = () => (
  ...
  >
    ...
    <path
      ...
      d="M7.25 10.25a.75.75 0 000 1.5h9.5a.75.75 0 000-1.5h-9.5zM7 14.25a.75.75 0 01.75-.75h5.5a.75.75 0 010 1.5h-5.5A.75.75 0 017 14.25z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3.375 12a8.625 8.625 0 1117.25 0 8.625 8.625 0 01-17.25 0z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 18.75a.75.75 0 100-1.5.75.75 0 000 1.5zM12 5.25a.75.75 0 100 1.5.75.75 0 000 1.5z"
    />
  </svg>
);
...
function SwitchDetailPage() {
  ...
  if (loading)
    return <div className="text-center p-8">Loading switch details...</div>;
  if (error)
    return (
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="card mt-2 flex items-center gap-6 p-4">
          {" "}
          {/* CHANGED */}
          ...
          <div>
            ...
            {/* CHANGED */}
            <div className="flex items-center gap-x-6 gap-y-1 text-sm text-[var(--color-text-secondary)] flex-wrap">
              {" "}
              {/* CHANGED */}
              <span>
                <strong>Model:</strong> {sw.model || "N/A"}
              </span>
              <span>
                <strong>IP Address:</strong> {sw.ip_address || "N/A"}
              </span>
            </div>
          </div>
        </div>
